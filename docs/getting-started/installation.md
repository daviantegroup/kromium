...
|---|---|---|
| **`dev.daviante:kromium-compose`** | Compose Multiplatform desktop UI bindings, `@Composable KromiumView`, and `KromiumViewState`. | [![Maven Central](https://img.shields.io/badge/Maven_Central-v1.2.150--b11-107c41?style=flat-square&logo=apachemaven)](https://central.sonatype.com/artifact/dev.daviante/kromium-compose) |
| **`dev.daviante:kromium-core`** | Core engine bootstrap, JCEF lifecycle manager, `KromiumClient`, and headless automation. | [![Maven Central](https://img.shields.io/badge/Maven_Central-v1.2.150--b11-107c41?style=flat-square&logo=apachemaven)](https://central.sonatype.com/artifact/dev.daviante/kromium-core) |
